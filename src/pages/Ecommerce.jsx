  ...
  return (
    <div className='mt-12' >
      <section className='flex flex-wrap lg:flex-nowrap justify-center'>
        <header className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center' >
        ...
        >
          {earningData.map((item) => (
            <div
              key={item.title}
              className='bg-white dark:text-gray-200 dark:bg-secondary-dark md:2-56 p-4 pt-9 rounded-2xl'
            >
              <button
                type='button'
